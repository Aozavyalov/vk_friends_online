...
def online_friends_output(online_friends_ids, token):
    ...
    for mode in online_friends_ids:
        ...
        #     online_friend.extend(vk.users.get(user_ids=user_id, v='5.63'))
        ...
        part_of_friends = response['response']
        online_friend.extend(part_of_friends)

    for friend in online_friend:
